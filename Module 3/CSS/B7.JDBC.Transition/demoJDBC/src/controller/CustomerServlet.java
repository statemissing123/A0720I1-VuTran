...
public class CustomerServlet extends HttpServlet {
    ...
    private void searchCustomer(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Customer> customerList = name == null ? customerService.findAll() : customerService.findByName(name);
...
//          }
    ...
    private void createCustomer(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        this.customerService.insertCusStore(customer);
        listCustomer(request, response);
    }
    ...
    private void viewUpdateCustomer(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        int id = Integer.parseInt(request.getParameter("id"));
        Customer existingCus = this.customerService.getCusById(id);
        request.setAttribute("customer", existingCus);
