...
public class CustomerServiceImpl implements CustomerService {
    ...
    public List<Customer> findByName(String name) {
        return this.findAll().stream().filter(cus -> cus.getName().toLowerCase().contains(name.toLowerCase())).collect(Collectors.toList());
    }
    ...
    @Override
    public void insertCusStore(Customer customer) {
        try {
            customerDAO.insertCustomer(customer);
        } catch (SQLException e) {
            e.printStackTrace();
